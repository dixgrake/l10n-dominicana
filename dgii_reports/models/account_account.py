...
class AccountAccount(models.Model):
    ...
    account_fiscal_type = fields.Selection(
        [
            ...
            (
                "A35",
                "A35 - " "Pagos Computables por Boletos Aéreos (N02-05) (BSP-IATA)",
            ),
            ("A36", "A36 - Pagos Computables por otras Retenciones (N02-05)"),
            (
                "A37",
                "A37 - " "Pagos Computables por Paquetes de Alojamiento y Ocupación",
            ),
            (
                "A38",
                "A38 - " "Crédito por retención realizada por Entidades del Estado",
            ),
            ...
            (
                "I03",
                "I03 - " "Ingresos por ventas locales de bienes o servicios exentos",
            ),
            (
                "I04",
                "I04 - "
